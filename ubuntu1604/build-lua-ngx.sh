...
--with-ipv6 \
--with-http_v2_module \
--with-cc-opt='-O2 -g -pipe -Wall -fexceptions -fstack-protector -m64 -mtune=generic -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong -fPIE' \
...
--with-ipv6 \
--with-http_v2_module \
--with-cc-opt='-O2 -g -pipe -Wall -fexceptions -fstack-protector -m64 -mtune=generic -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong' \
